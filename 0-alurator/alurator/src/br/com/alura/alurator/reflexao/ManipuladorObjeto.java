...
public class ManipuladorObjeto {
	...
	private boolean filterMetodo(Method metodo, String nomeMetodo, Map<String, Object> mapParametros) {
		...
		return metodo.getName().equals(nomeMetodo) && metodo.getParameterCount() == mapParametros.values().size()
				&& Stream.of(metodo.getParameters()).allMatch(parametroMetodo ->

				mapParametros.keySet().contains(parametroMetodo.getName())
